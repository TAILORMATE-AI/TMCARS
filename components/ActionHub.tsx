...
const ActionHub: React.FC = () => {
  ...
  return (
    <section id="diensten" className="w-full py-24 bg-[#020202] relative">
        ...
        >
          ...
          >
            <Link to="/verkopen" className="block h-full bg-[#0A0A0A] border border-white/10 hover:border-zinc-600 transition-colors duration-300 p-8 flex flex-col justify-between overflow-hidden cursor-pointer">
                ...
                <div className="z-10">
                <h3 className="text-lg font-bold text-white mb-2 uppercase tracking-widest">Wagen Verkopen?</h3>
          ...
          >
            ...
            <h4 className="text-base font-bold text-white uppercase tracking-widest">12 Maanden Garantie</h4>
          ...
          <motion.div variants={itemVariants} className="col-span-1 md:col-span-2 lg:col-start-3 lg:col-span-2 lg:row-start-1 lg:row-span-2 h-full">
            <Link to="/collectie" className="block h-full">
              ...
              >
                  ...
                  <img 
                      src="https://tailormate.ai/tmcars/images/homepagecollection3.png" 
                      alt="Onze Collectie" 
