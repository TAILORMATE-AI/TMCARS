            ...
            >
              <div className="space-y-8">
                ...
                <div className="space-y-8">
                  <div className="flex items-start space-x-6">
                    ...
                    <div>
                      <h4 className="text-xs font-bold text-gray-500 uppercase tracking-[0.2em] mb-2">Locatie</h4>
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div>
                      <h4 className="text-xs font-bold text-gray-500 uppercase tracking-[0.2em] mb-1">Telefoon</h4>
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div>
                      <h4 className="text-xs font-bold text-gray-500 uppercase tracking-[0.2em] mb-1">E-mail</h4>
              ...
              <div className="w-full h-64 bg-[#0a0a0a] border border-white/10 relative overflow-hidden group rounded-sm shadow-2xl">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="absolute bottom-4 right-4 bg-white text-black px-4 py-2 text-xs font-bold uppercase tracking-widest flex items-center gap-2 hover:bg-platinum transition-all z-10"
                >
            ...
            >
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">Bericht</label>
                    <textarea
                      rows={4}
                      required
                ...
                >
                  <div className="relative w-full">
                    ...
                    />
                    <div
                      className="absolute inset-[1.5px] bg-[#080808] transition-colors duration-500 ease-out group-hover:bg-white"
                      style={{ clipPath: clipPathValue }}
                    />

                    <div className="relative px-8 py-5 z-10 flex items-center justify-center space-x-3">
                      <span className="text-xs font-bold text-white tracking-[0.3em] uppercase transition-colors duration-500 ease-out group-hover:text-black font-sans">
