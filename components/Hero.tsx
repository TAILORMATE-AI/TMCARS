    ...
    <header className="relative w-full h-screen overflow-hidden flex flex-col items-center justify-center font-sans bg-[#020202]">
      ...
      <div className="absolute inset-0 w-full h-full z-0">
        <motion.img 
            ...
            src="https://tailormate.ai/tmcars/images/tm-cars-header.jpg"
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 max-w-5xl mx-auto mt-0">
        ...
        <motion.h1 
          ...
          className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-12 leading-tight bg-gradient-to-r from-white via-slate-200 to-white bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(255,255,255,0.2)] pb-4 px-2"
        >
          De juiste match voor elke weg,<br className="hidden md:block" /> voor elk budget.
        </motion.h1>
        ...
        >
            <div className="relative">
                ...
                <div className="relative px-12 py-5 z-10 flex items-center justify-center">
                    <span className="text-[0.7rem] font-bold text-white tracking-[0.25em] uppercase select-none transition-colors duration-300 group-hover:text-black">
                        Bekijk onze wagens
                    </span>
                </div>
            </div>
      ...
      <motion.div 
        ...
        className="absolute bottom-8 left-1/2 -translate-x-1/2 text-white/50 z-20 cursor-pointer hover:text-white transition-colors p-4"
